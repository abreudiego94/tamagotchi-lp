...
var Criatura_1 = __webpack_require__(2);
var Banco_1 = __webpack_require__(3);
...
exports.__esModule = true;
function getVitalidade() {
    return localStorage.getItem("vitalidade");
}
exports.getVitalidade = getVitalidade;
function getFelicidade() {
    return localStorage.getItem("felicidade");
}
exports.getFelicidade = getFelicidade;
function getFome() {
    return localStorage.getItem("fome");
}
exports.getFome = getFome;
function getUltimaAtualizacao() {
    return localStorage.getItem("hora");
}
exports.getUltimaAtualizacao = getUltimaAtualizacao;
function getEstado() {
...
exports.setVitalidade = setVitalidade;
function setFome(fome) {
    localStorage.setItem("fome", fome.toString());
}
exports.setFome = setFome;
function setFelicidade(felicidade) {
    localStorage.setItem("felicidade", felicidade.toString());
}
exports.setFelicidade = setFelicidade;
function setTempo() {
    localStorage.setItem("hora", new Date().getTime().toString());
}
exports.setTempo = setTempo;
function saveAll(vitalidade, fome, felicidade) {
...
exports.criaBanco = criaBanco;
function verificaBanco() {
    if (!localStorage.getItem("felicidade")) {
        return criaBanco();
    }
}
exports.verificaBanco = verificaBanco;
